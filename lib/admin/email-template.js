    ...
    htmlMessage += `<p style="margin: 30px 0 20px 0; text-align: center;">
      <a href="${finalAppStoreUrl}" target="_blank" rel="noopener noreferrer" style="display: inline-block; text-decoration: none;">
        <table cellpadding="0" cellspacing="0" style="margin: 0 auto; background: #000000; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.2);">
          <tr>
            <td style="padding: 12px 16px 12px 20px; vertical-align: middle;">
              <img src="${logoUrl}" alt="ORA" style="width: 24px; height: 24px; border-radius: 6px; display: block;" />
            </td>
            <td style="padding: 12px 20px 12px 10px; vertical-align: middle;">
              <span style="color: #ffffff; font-size: 15px; font-weight: 600; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; letter-spacing: 0.3px; white-space: nowrap;">
