        ...
        <tr>
          <td style="background: #000000; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.2);">
            <a href="${finalAppStoreUrl}" target="_blank" rel="noopener noreferrer" style="display: block; text-decoration: none !important; padding: 12px 24px; color: #ffffff !important; width: 100%; border: none; outline: none; text-decoration: none !important;">
              <table cellpadding="0" cellspacing="0" width="100%" style="border: none; margin: 0; padding: 0;">
                <tr>
                  <td style="text-align: center; padding: 0; margin: 0;">
                    <!-- Download arrow pointing down -->
                    <span style="font-size: 24px; color: #ffffff; font-weight: bold; line-height: 1; display: block; margin-bottom: 4px;">↓</span>
                    <span style="color: #ffffff !important; font-size: 15px; font-weight: 600; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; letter-spacing: 0.3px; line-height: 1.4; text-decoration: none !important; display: block;">
