              ...
              <table cellpadding="0" cellspacing="0" width="100%" style="border: none;">
                <tr>
                  <td style="padding-right: 12px; vertical-align: middle; text-align: center; width: 24px;">
                    <!-- Apple logo - use PNG image for Gmail compatibility (Gmail doesn't support SVG) -->
                    <img src="https://developer.apple.com/assets/elements/icons/download-on-the-app-store/download-on-the-app-store.svg" alt="Apple" width="18" height="18" style="display: block; width: 18px; height: 18px; border: none; outline: none; vertical-align: middle; background: transparent;" onerror="this.style.display='none'; this.parentElement.innerHTML='<span style=&quot;color: #ffffff; font-size: 16px; line-height: 1;&quot;>🍎</span>';" />
                  </td>
