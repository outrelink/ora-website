              ...
              <table cellpadding="0" cellspacing="0" width="100%" style="border: none;">
                <tr>
                  <td style="padding-right: 12px; vertical-align: middle; text-align: center; width: 24px;">
                    <!-- Apple logo - use emoji for now (works in all email clients including Gmail) -->
                    <!-- When apple-logo.png is added to the website root, change this to: -->
                    <!-- <img src="https://myora.co/apple-logo.png" alt="Apple" width="18" height="22" style="display: block; width: 18px; height: 22px; border: none; outline: none; vertical-align: middle;" /> -->
                    <span style="color: #ffffff; font-size: 18px; line-height: 1; display: inline-block; vertical-align: middle;">🍎</span>
                  </td>
