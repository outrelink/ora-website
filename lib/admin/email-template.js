              ...
              <table cellpadding="0" cellspacing="0" width="100%" style="border: none;">
                <tr>
                  <td style="padding-right: 12px; vertical-align: middle; text-align: center; width: 24px;">
                    <!-- Apple logo - embedded base64 PNG for maximum compatibility (works in Gmail and all email clients) -->
                    <span style="font-size: 20px; color: #ffffff; font-weight: bold; line-height: 1;">⌘</span>

Let me create a proper base64-encoded Apple logo. I'll use a simple white Apple logo that I can encode.
