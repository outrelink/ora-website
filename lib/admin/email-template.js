              ...
              <table cellpadding="0" cellspacing="0" width="100%" style="border: none;">
                <tr>
                  <td style="padding-right: 12px; vertical-align: middle; text-align: center; width: 24px;">
                    <!-- Apple logo - use text-based approach for maximum email compatibility -->
                    <span style="color: #ffffff; font-size: 16px; line-height: 1; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; display: inline-block; vertical-align: middle; font-weight: 300;">⌘</span>
                  </td>
