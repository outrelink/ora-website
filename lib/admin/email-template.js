              ...
              <table cellpadding="0" cellspacing="0" width="100%" style="border: none;">
                <tr>
                  <td style="padding-right: 12px; vertical-align: middle; text-align: center; width: 24px;">
                    <!-- Apple logo - use PNG image hosted on domain for Gmail compatibility -->
                    <img src="https://myora.co/apple-logo.png" alt="Apple" width="18" height="22" style="display: block; width: 18px; height: 22px; border: none; outline: none; vertical-align: middle; background: transparent;" onerror="this.style.display='none'; this.parentElement.innerHTML='<span style=&quot;color: #ffffff; font-size: 18px; line-height: 1; display: inline-block; vertical-align: middle;&quot;>🍎</span>';" />
                  </td>
