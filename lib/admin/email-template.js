      ...
      <table cellpadding="0" cellspacing="0" style="margin: 0 auto; border-collapse: separate; border-spacing: 0;">
        <tr>
          <td style="background: #333333; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.2); border: none;">
            <a href="${finalAppStoreUrl}" target="_blank" rel="noopener noreferrer" style="display: block; text-decoration: none !important; padding: 10px 20px; color: #ffffff !important; border: none; outline: none;">
              <table cellpadding="0" cellspacing="0" width="100%" style="border: none;">
                <tr>
                  <td style="text-align: center; padding: 0; border: none;">
                    ...
                    <div style="color: #ffffff !important; font-size: 14px; font-weight: 600; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; letter-spacing: 0.3px; line-height: 1.3; text-decoration: none !important;">
