  ...
  try {
    ...
    if (supabase) {
      ...
      if (!subsError && subsData) {
        ...
        // Build array from current month to 12 months ahead
        const revenueData = [];
        // Show next 12 months, starting from current month forward
        for (let i = 0; i < 12; i++) {
          // Calculate month: i=0 means current month, i=11 means 11 months ahead
